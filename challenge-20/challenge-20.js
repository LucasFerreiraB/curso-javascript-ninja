(function(win, doc){
    'use strict';
/* Exemplo variavies globais/locais:
var name = 'daciuk';
function myFunction() {
  var name = 'arroz';
...
/* Exemplo objeto global como referencia local: 
    (function(win) {
  console.log( win === window );
})(window); */

/* Exemplo simplificando loops:
(function(win) {
  if( win !== window )
    ...
    */
   //var usarname = prompt('Qual o seu nome?') || 'Desconhecido';
   ...
   $button.addEventListener('click', function(){
        ...
        if(!isValideEmail($inputEmail.value))
