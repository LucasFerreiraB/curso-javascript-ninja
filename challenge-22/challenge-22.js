(function(){
  'use strict';
    ...
    */
  var Luck = {name: 'Lucas', lastName: 'Ferreira'};
  var Rangot = {name: 'Luc', lastName: 'Barros'};
  ...
  console.log(getFullName.call(Luck));
  console.log(getFullName.call(Rangot));
    /*
  ...
  function sum (){
    ...
    */
    ...
    console.log(justNumbers('10ferdir2oi 3, 4'));
    /*
