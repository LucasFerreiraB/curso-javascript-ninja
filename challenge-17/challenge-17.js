(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Lucas Ferreira Barros'));
    /*
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/g, function(fodase) {
        return fodase.toUpperCase();
    }));
    ...
    */
    console.log( '\nReplace de datas:' );
    function replaceDate (regex, day, months, year) {
